...
export default function LoadingLive() {
  return (
    <div className="w-full h-auto aspect-video max-h-livestreamSize p-4 border border-gray-200 rounded shadow animate-pulse dark:border-gray-400">
      <div className="flex items-center justify-center h-full bg-gray-300 rounded dark:bg-gray-400">
        <svg
          viewBox="0 0 16 20"
          fill="currentColor"
